...
export const sendMessageFields: INodeProperties[] = [
	...
	// Update and Delete Scheduled Message operation fields
	{
		...
		required: true,
		default: '',
		description: 'The schedule identifier of the message to update or delete',
		displayOptions: {
			show: {
				operation: ['updateScheduledMessage', 'deleteScheduledMessage'],
			},
		},
	},
	{
		...
		type: 'dateTime',
		default: '',
		description: 'New time to schedule the message (ISO 8601 format)',
		displayOptions: {
			show: {
				operation: ['updateScheduledMessage'],
			},
		},
	},
	{
		displayName: 'Update Message Content',
		name: 'updateMessages',
		type: 'boolean',
		default: false,
		description: 'Whether to update the message content',
		displayOptions: {
			show: {
				operation: ['updateScheduledMessage'],
			},
	...
	},
	{
		...
		type: 'json',
		default: '{}',
		description: 'JSON object containing updated message content for different channels',
		displayOptions: {
			show: {
				operation: ['updateScheduledMessage'],
				updateMessages: [true],
